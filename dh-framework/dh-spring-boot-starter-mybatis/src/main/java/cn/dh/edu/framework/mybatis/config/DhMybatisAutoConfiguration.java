package cn.dh.edu.framework.mybatis.config;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.util.StrUtil;
import cn.dh.edu.framework.common.util.json.JsonUtils;
import cn.dh.edu.framework.mybatis.core.handler.DefaultDBFieldHandler;
...
@MapperScan(value = "${dh.info.base-package}", annotationClass = Mapper.class,
        lazyInitialization = "${mybatis.lazy-initialization:false}") // Mapper 懒加载，目前仅用于单元测试
public class DhMybatisAutoConfiguration {
