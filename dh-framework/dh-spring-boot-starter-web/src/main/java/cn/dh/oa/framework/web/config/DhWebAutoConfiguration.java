package cn.dh.oa.framework.web.config;
...
import cn.dh.oa.framework.web.core.filter.CacheRequestBodyFilter;
import cn.dh.oa.framework.web.core.filter.DemoFilter;
import cn.dh.oa.framework.web.core.handler.GlobalExceptionHandler;
import cn.dh.oa.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class DhWebAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "dh.demo", havingValue = "true")
