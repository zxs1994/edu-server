package cn.dh.edu.framework.jackson.config;

import cn.dh.edu.framework.common.util.json.JsonUtils;
import cn.dh.edu.framework.common.util.json.databind.LocalDateIsoSerializer;
import cn.dh.edu.framework.common.util.json.databind.LocalTimeIsoSerializer;
import cn.dh.edu.framework.common.util.json.databind.NumberSerializer;
import cn.dh.edu.framework.common.util.json.databind.TimestampLocalDateTimeDeserializer;
import cn.dh.edu.framework.common.util.json.databind.TimestampLocalDateTimeSerializer;
...
@Slf4j
public class DhJacksonAutoConfiguration {
