package cn.dh.edu.framework.swagger.config;
 ...
 * @author 鼎衡
 */
@AutoConfiguration(before = Knife4jAutoConfiguration.class) // before 原因，保证覆写的 Knife4jOpenApiCustomizer 先生效！相关 https://gitcode.com/zhouzhongyan/ruoyi-office.git/issues/954 讨论
@ConditionalOnClass({OpenAPI.class})
@EnableConfigurationProperties(SwaggerProperties.class)
@ConditionalOnProperty(prefix = "springdoc.api-docs", name = "enabled", havingValue = "true", matchIfMissing = true) // 设置为 false 时，禁用
@Import(Knife4jOpenApiCustomizer.class)
public class DhSwaggerAutoConfiguration {
     ...
     *
     * @see <a href="https://gitcode.com/zhouzhongyan/ruoyi-office.git/issues/957">app-api 前缀不生效，都是使用 admin-api</a>
     */
