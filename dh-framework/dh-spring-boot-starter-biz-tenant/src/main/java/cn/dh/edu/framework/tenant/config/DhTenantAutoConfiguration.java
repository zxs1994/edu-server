package cn.dh.edu.framework.tenant.config;
...
import cn.dh.edu.framework.mybatis.core.util.MyBatisUtils;
import cn.dh.edu.framework.redis.config.DhCacheProperties;
import cn.dh.edu.framework.security.core.service.SecurityFrameworkService;
import cn.dh.edu.framework.tenant.core.aop.TenantIgnore;
import cn.dh.edu.framework.tenant.core.aop.TenantIgnoreAspect;
import cn.dh.edu.framework.tenant.core.db.TenantDatabaseInterceptor;
import cn.dh.edu.framework.tenant.core.job.TenantJobAspect;
import cn.dh.edu.framework.tenant.core.mq.rabbitmq.TenantRabbitMQInitializer;
import cn.dh.edu.framework.tenant.core.mq.redis.TenantRedisMessageInterceptor;
import cn.dh.edu.framework.tenant.core.redis.TenantRedisCacheManager;
import cn.dh.edu.framework.tenant.core.security.TenantSecurityWebFilter;
import cn.dh.edu.framework.tenant.core.service.TenantFrameworkService;
import cn.dh.edu.framework.tenant.core.service.TenantFrameworkServiceImpl;
import cn.dh.edu.framework.tenant.core.web.TenantContextWebFilter;
import cn.dh.edu.framework.tenant.core.web.TenantVisitContextInterceptor;
...
public class DhTenantAutoConfiguration {
    ...
    public TenantFrameworkService tenantFrameworkService(TenantCommonApi tenantApi) {
        // 参见 https://gitee.com/zhijiantianya/dh-cloud/issues/IC6YZF
        try {
     ...
     */
    @Configuration
    @ConditionalOnClass(name = "cn.dh.edu.framework.mq.redis.core.RedisMQTemplate")
    ...
    public RedisCacheManager tenantRedisCacheManager(RedisTemplate<String, Object> redisTemplate,
                                                     ...
                                                     DhCacheProperties dhCacheProperties,
                                                     TenantProperties tenantProperties) {
        // 创建 RedisCacheWriter 对象
        RedisConnectionFactory connectionFactory = Objects.requireNonNull(redisTemplate.getConnectionFactory());
        RedisCacheWriter cacheWriter = RedisCacheWriter.nonLockingRedisCacheWriter(connectionFactory,
                BatchStrategies.scan(dhCacheProperties.getRedisScanBatchSize()));
