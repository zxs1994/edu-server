...
import cn.dh.oa.framework.redis.config.DhCacheProperties;
...
import cn.dh.oa.framework.tenant.core.aop.TenantIgnoreAspect;
import cn.dh.oa.framework.tenant.core.db.TenantDatabaseInterceptor;
...
import cn.dh.oa.framework.tenant.core.service.TenantFrameworkServiceImpl;
import cn.dh.oa.framework.tenant.core.web.TenantContextWebFilter;
import cn.dh.oa.framework.tenant.core.web.TenantVisitContextInterceptor;
import cn.dh.oa.framework.web.config.WebProperties;
import cn.dh.oa.framework.web.core.handler.GlobalExceptionHandler;
...
public class DhTenantAutoConfiguration {
     ...
     */
    @Configuration
    @ConditionalOnClass(name = "cn.dh.oa.framework.mq.redis.core.RedisMQTemplate")
