package cn.dh.edu.framework.excel.core.handler;
...
import cn.dh.edu.framework.excel.core.annotations.ExcelColumnSelect;
import cn.dh.edu.framework.excel.core.function.ExcelColumnSelectFunction;
...
public class SelectSheetWriteHandler implements SheetWriteHandler {
    ...
    public SelectSheetWriteHandler(Class<?> head) {
        ...
        for (Field field : head.getDeclaredFields()) {
            // 关联 https://gitcode.com/zhouzhongyan/ruoyi-office.git/pull/853
