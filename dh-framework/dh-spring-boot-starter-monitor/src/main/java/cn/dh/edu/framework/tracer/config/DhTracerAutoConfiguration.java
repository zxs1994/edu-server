...
import cn.dh.edu.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "dh.tracer", value = "enable", matchIfMissing = true)
public class DhTracerAutoConfiguration {
