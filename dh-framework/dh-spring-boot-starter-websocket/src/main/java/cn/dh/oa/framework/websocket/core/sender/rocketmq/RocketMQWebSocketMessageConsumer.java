package cn.dh.oa.framework.websocket.core.sender.rocketmq;
...
@RocketMQMessageListener( // 重点：添加 @RocketMQMessageListener 注解，声明消费的 topic
        topic = "${dh.websocket.sender-rocketmq.topic}",
        consumerGroup = "${dh.websocket.sender-rocketmq.consumer-group}",
