package cn.dh.oa.framework.common.util.json.databind;
...
/**
 * LocalTime 序列化器：默认输出 ISO 字符串（如 "10:30:00"），
 * 支持通过 @JsonFormat(pattern=...) 自定义格式。
 * <p>
 * 解决全局 write-dates-as-timestamps=true 导致 LocalTime 输出为数组 [10,30] 的问题。
 *
 * @author QoderWork
 */
@Slf4j
public class LocalTimeIsoSerializer extends JsonSerializer<LocalTime> {

    public static final LocalTimeIsoSerializer INSTANCE = new LocalTimeIsoSerializer();
