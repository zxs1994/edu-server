package cn.dh.oa.framework.common.biz.system.oauth2;

import cn.dh.oa.framework.common.enums.RpcConstants;
import cn.dh.oa.framework.common.pojo.CommonResult;
import cn.dh.oa.framework.common.biz.system.oauth2.dto.OAuth2AccessTokenCheckRespDTO;
import cn.dh.oa.framework.common.biz.system.oauth2.dto.OAuth2AccessTokenCreateReqDTO;
import cn.dh.oa.framework.common.biz.system.oauth2.dto.OAuth2AccessTokenRespDTO;
...
public interface OAuth2TokenCommonApi {
    ...
    @Parameters({
        ...
        @Parameter(name = "clientId", description = "客户端编号", required = true, example = "dhyuanma")
    })
