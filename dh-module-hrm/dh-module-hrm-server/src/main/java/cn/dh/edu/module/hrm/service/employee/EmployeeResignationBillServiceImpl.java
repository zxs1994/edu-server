...
import static cn.dh.edu.module.hrm.enums.ErrorCodeConstants.EMPLOYEE_RESIGNATION_BILL_NOT_EXISTS;
...
public class EmployeeResignationBillServiceImpl implements EmployeeResignationBillService, FlowBillService<HrmBillTypeEnum> {
    ...
    private void validateEmployeeExists(Long employeeId) {
        if (employeeMapper.selectById(employeeId) == null) {
            throw exception(cn.dh.edu.module.hrm.enums.ErrorCodeConstants.EMPLOYEE_ARCHIVE_NOT_EXISTS);
        }
    }
