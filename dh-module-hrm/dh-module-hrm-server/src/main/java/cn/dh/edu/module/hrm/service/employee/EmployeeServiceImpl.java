...
import static cn.dh.edu.module.hrm.enums.ErrorCodeConstants.EMPLOYEE_ARCHIVE_NOT_EXISTS;
...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    public Long generateUserForEmployee(Long employeeId) {
        ...
        userCreateReqDTO.setUsername(employee.getEmployeeNo()); // 用户账号为员工工号
    ...
    private void syncEmployeeToUser(EmployeeSaveReqVO employee, Long userId) {
        ...
        userUpdateReqDTO.setUsername(employee.getEmployeeNo()); // 用户账号为员工工号
