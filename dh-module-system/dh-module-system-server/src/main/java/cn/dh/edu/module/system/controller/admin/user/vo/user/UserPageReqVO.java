...
public class UserPageReqVO extends PageParam {
    ...
    @Schema(description = "用户账号，模糊匹配", example = "dh")
    private String username;

    @Schema(description = "用户昵称，模糊匹配", example = "张三")
    private String nickname;

    @Schema(description = "手机号码，模糊匹配", example = "dh")
    ...
    @Schema(description = "包含的角色编码（逗号分隔，如 student,teacher）", example = "student,teacher")
