...
import cn.dh.edu.module.system.dal.mysql.home.HomePageLayoutMapper;
import cn.dh.edu.module.system.dal.mysql.home.HomePageMapper;
import cn.dh.edu.module.system.dal.mysql.home.UserHomePageMapper;
...
public class HomePageServiceImpl implements HomePageService {
    ...
    public void setMyHomePage(Long id) {
        ...
        if (!cn.dh.edu.framework.common.enums.CommonStatusEnum.ENABLE.getStatus().equals(homePage.getStatus())) {
    ...
    private void validateAdminPermission() {
        Long userId = cn.dh.edu.framework.security.core.util.SecurityFrameworkUtils.getLoginUserId();
        // 检查是否有系统管理权限
        cn.dh.edu.framework.security.core.util.SecurityFrameworkUtils.getLoginUser();
