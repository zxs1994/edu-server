package cn.dh.edu.module.system.service.permission;
...
import cn.dh.edu.module.system.dal.dataobject.permission.RoleMenuDO;
import cn.dh.edu.module.system.dal.dataobject.permission.UserRoleDO;
import cn.dh.edu.module.system.dal.mysql.permission.RoleMenuMapper;
import cn.dh.edu.module.system.dal.mysql.permission.UserRoleMapper;
import cn.dh.edu.module.system.dal.redis.RedisKeyConstants;
import cn.dh.edu.module.system.enums.permission.DataScopeEnum;
...
import static cn.dh.edu.module.system.enums.ErrorCodeConstants.USER_ROLE_ASSIGN_FORBIDDEN;
...
public class PermissionServiceImpl implements PermissionService {
    ...
    public void assignUserRole(Long userId, Set<Long> roleIds) {
        ...
        if (CollUtil.isNotEmpty(dbRoleIds)) {
            List<RoleDO> dbRoles = roleService.getRoleList(dbRoleIds);
            boolean fixedIdentity = dbRoles.stream()
                    .anyMatch(role -> RoleCodeEnum.isFixedIdentityRole(role.getCode()));
            if (fixedIdentity) {
                throw exception(USER_ROLE_ASSIGN_FORBIDDEN);
            }
        }
