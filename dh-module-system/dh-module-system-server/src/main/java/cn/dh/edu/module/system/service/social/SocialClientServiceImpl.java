package cn.dh.edu.module.system.service.social;
...
import cn.dh.edu.framework.common.util.cache.CacheUtils;
import cn.dh.edu.framework.common.util.http.HttpUtils;
import cn.dh.edu.framework.common.util.object.BeanUtils;
import cn.dh.edu.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import cn.dh.edu.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
import cn.dh.edu.module.system.api.social.dto.SocialWxaOrderUploadShippingInfoReqDTO;
import cn.dh.edu.module.system.api.social.dto.SocialWxaSubscribeMessageSendReqDTO;
import cn.dh.edu.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import cn.dh.edu.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import cn.dh.edu.module.system.dal.dataobject.social.SocialClientDO;
import cn.dh.edu.module.system.dal.mysql.social.SocialClientMapper;
import cn.dh.edu.module.system.dal.redis.RedisKeyConstants;
import cn.dh.edu.module.system.enums.social.SocialTypeEnum;
import cn.dh.edu.module.system.framework.justauth.core.AuthRequestFactory;
...
import static cn.dh.edu.framework.common.util.collection.MapUtils.findAndThen;
import static cn.dh.edu.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static cn.dh.edu.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
import static cn.dh.edu.framework.common.util.json.JsonUtils.toJsonString;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${dh.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${dh.wxa-subscribe-message.miniprogram-state:formal}")
    ...
    public void uploadWxaOrderShippingInfo(Integer userType, SocialWxaOrderUploadShippingInfoReqDTO reqDTO) {
        ...
        // 对应 ISSUE：https://gitee.com/zhijiantianya/dh-cloud/pulls/230
