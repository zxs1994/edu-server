package cn.dh.oa.module.system.service.user;

import cn.hutool.core.util.RandomUtil;
import cn.dh.oa.framework.common.enums.CommonStatusEnum;
import cn.dh.oa.framework.common.exception.ServiceException;
import cn.dh.oa.framework.common.pojo.CommonResult;
import cn.dh.oa.framework.common.pojo.PageResult;
import cn.dh.oa.framework.common.util.collection.ArrayUtils;
import cn.dh.oa.framework.common.util.collection.CollectionUtils;
import cn.dh.oa.framework.test.core.ut.BaseDbUnitTest;
import cn.dh.oa.module.infra.api.config.ConfigApi;
import cn.dh.oa.module.infra.api.file.FileApi;
import cn.dh.oa.module.hrm.api.employee.EmployeeApi;
import cn.dh.oa.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import cn.dh.oa.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import cn.dh.oa.module.system.controller.admin.user.vo.user.UserImportExcelVO;
import cn.dh.oa.module.system.controller.admin.user.vo.user.UserImportRespVO;
import cn.dh.oa.module.system.controller.admin.user.vo.user.UserPageReqVO;
...
import cn.dh.oa.module.system.dal.dataobject.dept.UserPostDO;
import cn.dh.oa.module.system.dal.dataobject.tenant.TenantDO;
import cn.dh.oa.module.system.dal.dataobject.user.AdminUserDO;
import cn.dh.oa.module.system.dal.mysql.dept.UserPostMapper;
import cn.dh.oa.module.system.dal.mysql.user.AdminUserMapper;
import cn.dh.oa.module.system.enums.common.SexEnum;
import cn.dh.oa.module.system.service.dept.DeptService;
import cn.dh.oa.module.system.service.dept.PostService;
...
import cn.dh.oa.module.system.service.tenant.TenantService;
...
import static cn.dh.oa.framework.common.util.collection.SetUtils.asSet;
import static cn.dh.oa.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static cn.dh.oa.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static cn.dh.oa.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static cn.dh.oa.framework.test.core.util.AssertUtils.assertPojoEquals;
import static cn.dh.oa.framework.test.core.util.AssertUtils.assertServiceException;
import static cn.dh.oa.framework.test.core.util.RandomUtils.*;
import static cn.dh.oa.module.system.enums.ErrorCodeConstants.*;
import static cn.dh.oa.module.system.service.user.AdminUserServiceImpl.USER_INIT_PASSWORD_KEY;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void before() {
        // mock 初始化密码
        when(configApi.getConfigValueByKey(USER_INIT_PASSWORD_KEY)).thenReturn(success("dhyuanma"));
    }
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("dhyuanma");
        ...
        assertEquals("dhyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("dhyuanma"))).thenReturn("java");
