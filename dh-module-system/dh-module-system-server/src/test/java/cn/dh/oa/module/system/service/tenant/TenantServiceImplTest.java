package cn.dh.oa.module.system.service.tenant;

import cn.dh.oa.framework.common.enums.CommonStatusEnum;
import cn.dh.oa.framework.common.pojo.PageResult;
import cn.dh.oa.framework.tenant.config.TenantProperties;
import cn.dh.oa.framework.tenant.core.context.TenantContextHolder;
import cn.dh.oa.framework.test.core.ut.BaseDbUnitTest;
import cn.dh.oa.module.system.controller.admin.tenant.vo.tenant.TenantPageReqVO;
import cn.dh.oa.module.system.controller.admin.tenant.vo.tenant.TenantSaveReqVO;
...
import cn.dh.oa.module.system.dal.dataobject.tenant.TenantPackageDO;
import cn.dh.oa.module.system.dal.mysql.tenant.TenantMapper;
import cn.dh.oa.module.system.enums.permission.RoleCodeEnum;
import cn.dh.oa.module.system.enums.permission.RoleTypeEnum;
...
import cn.dh.oa.module.system.service.tenant.handler.TenantInfoHandler;
import cn.dh.oa.module.system.service.tenant.handler.TenantMenuHandler;
...
import static cn.dh.oa.module.system.dal.dataobject.tenant.TenantDO.PACKAGE_ID_SYSTEM;
...
public class TenantServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateTenant() {
        ...
        when(userService.createUser(argThat(user -> {
            ...
            assertEquals("鼎衡", user.getNickname());
    ...
    public void testGetTenantByName() {
        // mock 数据
        TenantDO dbTenant = randomPojo(TenantDO.class, o -> o.setName("鼎衡"));
        tenantMapper.insert(dbTenant);// @Sql: 先插入出一条存在的数据

        // 调用
        TenantDO result = tenantService.getTenantByName("鼎衡");
        // 校验存在
        assertPojoEquals(result, dbTenant);
    }
