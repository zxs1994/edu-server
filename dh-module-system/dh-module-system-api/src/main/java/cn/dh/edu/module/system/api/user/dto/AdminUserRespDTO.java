package cn.dh.edu.module.system.api.user.dto;
...
public class AdminUserRespDTO implements VO {
    ...
    @Schema(description = "用户账号", requiredMode = Schema.RequiredMode.REQUIRED, example = "xiaowang")
    ...
    @Schema(description = "用户头像", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.ruoyioffice.com/1.png")
