...
public interface ErrorCodeConstants {
    ...
    ErrorCode USER_ROLE_ASSIGN_FORBIDDEN = new ErrorCode(1_002_003_012, "学生/教培账号不允许重新分配角色");
    ErrorCode USER_CAN_NOT_DELETE_ADMIN = new ErrorCode(1_002_003_013, "不能删除超级管理员用户");
    ErrorCode USER_CAN_NOT_DISABLE_ADMIN = new ErrorCode(1_002_003_014, "不能禁用超级管理员用户");
    ErrorCode USER_USERNAME_UPDATE_FORBIDDEN = new ErrorCode(1_002_003_015, "学生/教培账号不允许修改用户账号");
    ErrorCode USER_MOBILE_REQUIRED = new ErrorCode(1_002_003_016, "学生/教培账号手机号不能为空");
