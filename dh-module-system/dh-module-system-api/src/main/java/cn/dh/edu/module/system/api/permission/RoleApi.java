...
public interface RoleApi {
    ...
    @GetMapping(PREFIX + "/get-id-by-code")
    @Operation(summary = "根据角色编码获得角色编号")
    @Parameter(name = "code", description = "角色编码", example = "student", required = true)
    CommonResult<Long> getRoleIdByCode(@RequestParam("code") String code);
