package cn.dh.oa.module.system.api.social;

import cn.dh.oa.framework.common.pojo.CommonResult;
import cn.dh.oa.module.system.api.social.dto.*;
import cn.dh.oa.module.system.enums.ApiConstants;
...
public interface SocialClientApi {
    ...
    @Parameters({
            ...
            @Parameter(name = "redirectUri", description = "重定向 URL", example = "https://www.ruoyioffice.com", required = true)
    })
    ...
    @Parameters({
            @Parameter(name = "userType", description = "用户类型", example = "1", required = true),
            @Parameter(name = "url", description = "访问 URL", example = "https://www.ruoyioffice.com", required = true)
    })
    ...
    @Parameters({
            @Parameter(name = "userType", description = "用户类型", example = "1", required = true),
            @Parameter(name = "phoneCode", description = "手机授权码", example = "dh11", required = true)
    })
