...
import cn.dh.edu.module.bpm.controller.admin.task.vo.task.*;
import cn.dh.edu.module.bpm.convert.task.BpmTaskConvert;
import cn.dh.edu.module.bpm.dal.dataobject.definition.BpmFormDO;
...
import cn.dh.edu.module.bpm.enums.definition.*;
import cn.dh.edu.module.bpm.enums.task.*;
...
import cn.dh.edu.module.bpm.service.definition.BpmFormService;
import cn.dh.edu.module.bpm.service.definition.BpmModelService;
...
import cn.dh.edu.module.bpm.service.message.dto.BpmMessageSendWhenTaskTimeoutReqDTO;
...
import static cn.dh.edu.module.bpm.enums.task.BpmReasonEnum.ASSIGN_START_USER_WITHDRAW;
import static cn.dh.edu.module.bpm.enums.task.BpmnModelConstants.START_USER_NODE_ID;
import static cn.dh.edu.module.bpm.framework.flowable.core.util.BpmnModelUtils.*;
...
//        }
    ...
    public List<UserTask> getUserTaskListByReturn(String id) {
        ...
        // 2.3 过滤：只能退回到已经处理过的节点（排除审批未经过的节点）。相关 issue：https://gitcode.com/zhouzhongyan/ruoyi-office.git/issues/982
    ...
    public void returnTask(Long userId, BpmnModel bpmnModel, Task currentTask, FlowElement targetElement, BpmTaskReturnReqVO reqVO) {
        ...
        //    相关 issue：https://gitcode.com/zhouzhongyan/ruoyi-office.git/issues/1018
    ...
    public void delegateTask(Long userId, BpmTaskDelegateReqVO reqVO) {
        ...
        // 特殊：如果已经被委派（owner 非空），则不需要更新 owner：https://gitee.com/zhijiantianya/dh-cloud/issues/ICJ153
    ...
    public void transferTask(Long userId, BpmTaskTransferReqVO reqVO) {
        ...
        // 3.1 设置任务所有人 (owner) 为原任务的处理人 (assignee)
        // 特殊：如果已经被转派（owner 非空），则不需要更新 owner：https://gitee.com/zhijiantianya/dh-cloud/issues/ICJ153
        if (StrUtil.isEmpty(task.getOwner())) {
            taskService.setOwner(taskId, task.getAssignee());
        }
    ...
    public void processTaskCreated(Task task) {
        ...
        TransactionSynchronizationManager.registerSynchronization(new TransactionSynchronization() {
             ...
             * 参见 <a href="https://gitee.com/zhijiantianya/dh-cloud/issues/IB7V7Q">issue</a> 反馈
             */
            @Override
