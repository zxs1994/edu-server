package cn.dh.oa.module.bpm.framework.rpc.config;

import cn.dh.oa.module.bpm.api.event.CrmContractStatusListener;
import cn.dh.oa.module.bpm.api.event.CrmReceivableStatusListener;
...
import cn.dh.oa.module.system.api.permission.PermissionApi;
import cn.dh.oa.module.system.api.permission.RoleApi;
...
public class RpcConfiguration {
    ...
    // ========== 特殊：解决微 dh-cloud 微服务场景下，跨服务（进程）无法 Listener 的问题 ==========
