package cn.dh.oa.module.bpm.controller.admin.task.vo.task;
...
public class BpmTaskRespVO {
    ...
    @Schema(description = "任务名字", requiredMode = Schema.RequiredMode.REQUIRED, example = "鼎衡")
    private String name;
    ...
    public static class ProcessInstance {
        ...
        @Schema(description = "流程实例名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "鼎衡")
        private String name;
        ...
        @Schema(description = "公司名称", example = "鼎衡")
