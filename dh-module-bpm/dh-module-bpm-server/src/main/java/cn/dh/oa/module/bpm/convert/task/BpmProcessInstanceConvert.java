package cn.dh.oa.module.bpm.convert.task;
...
import cn.dh.oa.module.bpm.controller.admin.definition.vo.process.BpmProcessDefinitionRespVO;
import cn.dh.oa.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO;
import cn.dh.oa.module.bpm.controller.admin.task.vo.instance.BpmProcessInstanceBpmnModelViewRespVO;
import cn.dh.oa.module.bpm.controller.admin.task.vo.instance.BpmProcessInstanceRespVO;
import cn.dh.oa.module.bpm.controller.admin.task.vo.instance.BpmProcessPrintDataRespVO;
import cn.dh.oa.module.bpm.controller.admin.task.vo.task.BpmTaskRespVO;
import cn.dh.oa.module.bpm.convert.definition.BpmProcessDefinitionConvert;
import cn.dh.oa.module.bpm.dal.dataobject.definition.BpmCategoryDO;
...
import cn.dh.oa.module.bpm.service.message.dto.BpmMessageSendWhenProcessInstanceApproveReqDTO;
...
public interface BpmProcessInstanceConvert {
    ...
    default PageResult<BpmProcessInstanceRespVO> buildProcessInstancePage(PageResult<HistoricProcessInstance> pageResult,
        ...
        for (int i = 0; i < pageResult.getList().size(); i++) {
            ...
            MapUtils.findAndThen(processDefinitionInfoMap, respVO.getProcessDefinitionId(),
                    info -> {
                        if (respVO.getProcessDefinition() != null) {
                            copyTo(info, respVO.getProcessDefinition());
                        }
                    });
