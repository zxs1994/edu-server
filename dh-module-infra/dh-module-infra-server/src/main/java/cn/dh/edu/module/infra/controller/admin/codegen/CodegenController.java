package cn.dh.edu.module.infra.controller.admin.codegen;
...
import cn.dh.edu.module.infra.controller.admin.codegen.vo.CodegenDetailRespVO;
import cn.dh.edu.module.infra.controller.admin.codegen.vo.CodegenPreviewRespVO;
...
import cn.dh.edu.module.infra.controller.admin.codegen.vo.table.CodegenTableRespVO;
import cn.dh.edu.module.infra.controller.admin.codegen.vo.table.DatabaseTableRespVO;
import cn.dh.edu.module.infra.convert.codegen.CodegenConvert;
...
import cn.dh.edu.module.infra.service.codegen.CodegenService;
...
import static cn.dh.edu.framework.security.core.util.SecurityFrameworkUtils.getLoginUserNickname;
import static cn.dh.edu.module.infra.framework.file.core.utils.FileTypeUtils.writeAttachment;
...
public class CodegenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "name", description = "表名，模糊匹配", example = "dh"),
            @Parameter(name = "comment", description = "描述，模糊匹配", example = "鼎衡")
    })
