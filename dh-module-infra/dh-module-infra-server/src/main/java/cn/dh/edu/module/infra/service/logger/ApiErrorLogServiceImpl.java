package cn.dh.edu.module.infra.service.logger;
...
import cn.dh.edu.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import cn.dh.edu.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import cn.dh.edu.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import cn.dh.edu.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static cn.dh.edu.module.infra.dal.dataobject.logger.ApiErrorLogDO.REQUEST_PARAMS_MAX_LENGTH;
import static cn.dh.edu.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static cn.dh.edu.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImpl implements ApiErrorLogService {
    ...
    public void createApiErrorLog(ApiErrorLogCreateReqDTO createDTO) {
        ...
        try {
            ...
            // 兜底处理，目前只有 dh-cloud 会发生：https://gitee.com/dhcode/dh-cloud-mini/issues/IC1O0A
