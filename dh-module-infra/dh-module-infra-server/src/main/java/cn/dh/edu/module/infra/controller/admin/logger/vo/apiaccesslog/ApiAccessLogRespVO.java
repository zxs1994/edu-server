package cn.dh.edu.module.infra.controller.admin.logger.vo.apiaccesslog;

import cn.dh.edu.framework.excel.core.annotations.DictFormat;
import cn.dh.edu.framework.excel.core.convert.DictConvert;
import cn.dh.edu.module.infra.enums.DictTypeConstants;
...
public class ApiAccessLogRespVO {
    ...
    @Schema(description = "结果提示", example = "鼎衡，牛逼！")
    @ExcelProperty("结果提示")
