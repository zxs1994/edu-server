...
import cn.dh.edu.module.infra.enums.codegen.CodegenColumnHtmlTypeEnum;
import cn.dh.edu.module.infra.enums.codegen.CodegenColumnListConditionEnum;
...
public class CodegenBuilder {
    ...
    /**
     * {@link cn.dh.edu.framework.mybatis.core.dataobject.BaseDO} 的字段
     */
    ...
    private void processColumnExample(CodegenColumnDO column) {
        ...
        if (StrUtil.endWithIgnoreCase(column.getColumnName(), "url")) {
            column.setExample("https://www.ruoyioffice.com");
            return;
        }
        // reason
