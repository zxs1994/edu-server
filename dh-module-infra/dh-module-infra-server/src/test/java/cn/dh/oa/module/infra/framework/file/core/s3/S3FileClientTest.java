package cn.dh.oa.module.infra.framework.file.core.s3;
...
public class S3FileClientTest {
    ...
    public void testAliyun() throws Exception {
        ...
        config.setDomain(null); // 如果有自定义域名，则可以设置。http://ali-oss.ruoyioffice.com
        // 默认北京的 endpoint
    ...
    public void testQCloud() throws Exception {
        ...
        config.setDomain(null); // 如果有自定义域名，则可以设置。http://tengxun-oss.ruoyioffice.com
        // 默认上海的 endpoint
...
//        config.setAccessSecret(System.getenv("QINIU_SECRET_KEY"));
        ...
        config.setDomain("http://test.dh.ruoyioffice.com"); // 如果有自定义域名，则可以设置。http://static.dh.ruoyioffice.com
...
//        config.setAccessSecret(System.getenv("QINIU_SECRET_KEY"));
        ...
        config.setDomain("http://t151glocd.hn-bkt.clouddn.com"); // 如果有自定义域名，则可以设置。http://static.dh.ruoyioffice.com
        config.setEnablePathStyleAccess(false);
        // 默认上海的 endpoint
        config.setEndpoint("s3-cn-south-1.qiniucs.com");
