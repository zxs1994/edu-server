package cn.dh.oa.module.infra.service.logger;
...
import cn.dh.oa.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import cn.dh.oa.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import cn.dh.oa.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import cn.dh.oa.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static cn.dh.oa.framework.common.util.date.LocalDateTimeUtils.*;
...
import static cn.dh.oa.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static cn.dh.oa.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        reqVO.setApplicationName("dh-test");
