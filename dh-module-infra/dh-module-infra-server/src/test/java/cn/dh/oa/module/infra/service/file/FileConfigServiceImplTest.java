package cn.dh.oa.module.infra.service.file;
...
import cn.dh.oa.module.infra.controller.admin.file.vo.config.FileConfigSaveReqVO;
import cn.dh.oa.module.infra.dal.dataobject.file.FileConfigDO;
import cn.dh.oa.module.infra.dal.mysql.file.FileConfigMapper;
import cn.dh.oa.module.infra.framework.file.core.client.FileClient;
import cn.dh.oa.module.infra.framework.file.core.client.FileClientConfig;
import cn.dh.oa.module.infra.framework.file.core.client.FileClientFactory;
import cn.dh.oa.module.infra.framework.file.core.client.local.LocalFileClient;
import cn.dh.oa.module.infra.framework.file.core.client.local.LocalFileClientConfig;
import cn.dh.oa.module.infra.framework.file.core.enums.FileStorageEnum;
...
import static cn.dh.oa.framework.test.core.util.RandomUtils.randomLongId;
import static cn.dh.oa.framework.test.core.util.RandomUtils.randomPojo;
import static cn.dh.oa.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_DELETE_FAIL_MASTER;
import static cn.dh.oa.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_NOT_EXISTS;
...
public class FileConfigServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetFileConfigPage() {
        // mock 数据
        FileConfigDO dbFileConfig = randomFileConfigDO().setName("鼎衡")
